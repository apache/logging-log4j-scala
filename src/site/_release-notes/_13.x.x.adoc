...
* Update `apache/logging-parent` to version `` (https://github.com/apache/logging-log4j-scala/pull/45[45])
* Update `org.apache.logging.log4j:log4j-bom` to version `2.22.1` (https://github.com/apache/logging-log4j-scala/pull/43[43])
* Update `org.apache.logging:logging-parent` to version `10.6.0` (https://github.com/apache/logging-log4j-scala/pull/44[44])
